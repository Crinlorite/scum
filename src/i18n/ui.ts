...
export const UI: Partial<Record<LangCode, Dict>> = {
  es: {
    ...
    'item.range': 'Alcance',
    'item.rof': 'Cadencia',
    'item.weaponClass': 'Clase de arma',
    'item.chamber': 'Recámara',
    'item.zeroing': 'Paso de calibrado',
    'item.attachments': 'Accesorios admitidos',
    ...
    'item.cookedHere': 'Recetas que se preparan aquí',
    'item.usedInCrafting': 'Se usa para fabricar',
    'item.soldAsPack': 'No se vende suelto — en paquete sí',
    'item.edible': 'Comestible',
    'item.drinkable': 'Bebible',
    'item.poisonous': 'Venenosa — no la comas',
    ...
    'sec.controls.title': 'Controles',
    'sec.controls.intro': 'Teclas por defecto del juego, por categoría (teclado y ratón).',
    'sec.controls.search': 'Buscar acción o tecla…',
  ...
  en: {
    ...
    'item.zeroing': 'Zeroing step',
    'item.attachments': 'Supported attachments',
    ...
    'item.cookedHere': 'Recipes cooked here',
    'item.usedInCrafting': 'Used to craft',
    'item.soldAsPack': 'Not sold loose — sold as a pack',
    'item.edible': 'Edible',
    'item.drinkable': 'Drinkable',
    'item.poisonous': 'Poisonous — do not eat',
    ...
    'sec.controls.title': 'Controls',
    'sec.controls.intro': 'Default game keys, by category (keyboard & mouse).',
    'sec.controls.search': 'Search action or key…',
