...
export const LANGUAGES = [
  ...
  { code: 'es',    label: 'Español',              native: 'Español',      bcp47: 'es-ES', ogLocale: 'es_ES', dir: 'ltr' },
  { code: 'en',    label: 'English',              native: 'English',      bcp47: 'en-US', ogLocale: 'en_US', dir: 'ltr' },

  // Other SCUM official languages, in the order Steam lists them
  { code: 'de',    label: 'German',               native: 'Deutsch',      bcp47: 'de-DE', ogLocale: 'de_DE', dir: 'ltr' },
  { code: 'ru',    label: 'Russian',              native: 'Русский',      bcp47: 'ru-RU', ogLocale: 'ru_RU', dir: 'ltr' },
  { code: 'zh',    label: 'Simplified Chinese',   native: '简体中文',      bcp47: 'zh-CN', ogLocale: 'zh_CN', dir: 'ltr' },
  { code: 'fr',    label: 'French',               native: 'Français',     bcp47: 'fr-FR', ogLocale: 'fr_FR', dir: 'ltr' },
  { code: 'pt',    label: 'Portuguese (Brazil)',  native: 'Português',    bcp47: 'pt-BR', ogLocale: 'pt_BR', dir: 'ltr' },
  { code: 'zh-tw', label: 'Traditional Chinese',  native: '繁體中文',      bcp47: 'zh-TW', ogLocale: 'zh_TW', dir: 'ltr' },
  { code: 'th',    label: 'Thai',                 native: 'ไทย',          bcp47: 'th-TH', ogLocale: 'th_TH', dir: 'ltr' },
  { code: 'pl',    label: 'Polish',               native: 'Polski',       bcp47: 'pl-PL', ogLocale: 'pl_PL', dir: 'ltr' },
] as const;
